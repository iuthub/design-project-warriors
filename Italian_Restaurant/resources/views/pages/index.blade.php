      ...
      <div class="row">
         <div class="col-md-12">
           ...
           <div class="mealselectbuttoncontainer">
            <h3 class="mealselectbuttons" id="mains"><button style=" background-color:white; border-style:none">Mains</button></h3>
            <h3 class="mealselectbuttons"  id="deserts"><button style=" background-color:white; border-style:none">Deserts</button></h3>
            <h3 class="mealselectbuttons"  id="drinks"><button style=" background-color:white; border-style:none">Drinks</button></h3>
            <h3 class="mealselectbuttons"><a href="#">hello</a></h3>
           </div>
         </div>
      </div>
      <br>
...
//new cards(hidden)
<div class="nonactivecards" id="drinkscontent">
      <div class="cards ">
            <img class="cardimg" src="./images/menu.png" alt="menu">
            <h5 class="card-title">Card bbbbtitle1</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the 
               bulk of the card's content.
            </p>
      </div>
      <div class="cards " >
         <img class="cardimg" src="./images/serving-dish.png" alt="dish">
            <h5 class="card-title">Card bbbbbtitle2</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the 
               bulk of the card's content.
            </p>
      </div>
      <div class="cards " >
         <img class="cardimg" src="./images/serving-dish.png" alt="dish">
            <h5 class="card-title">Card bbbbbtitle3</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the 
               bulk of the card's content.
            </p>
      </div>
      <div class="cards " >
         <img class="cardimg" src="./images/serving-dish.png" alt="dish">
            <h5 class="card-title">Card bbbbtitle4</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the 
               bulk of the card's content.
            </p>
      </div>
...
<div class="nonactivecards" id="desertcontent">
   <div class="cards ">
         <img class="cardimg" src="./images/menu.png" alt="menu">
         <h5 class="card-title">Card aaaatitle1</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the 
            bulk of the card's content.
         </p>
   </div>
   <div class="cards " >
      <img class="cardimg" src="./images/serving-dish.png" alt="dish">
         <h5 class="card-title">Card aaaatitle2</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the 
            bulk of the card's content.
         </p>
   </div>
   <div class="cards " >
      <img class="cardimg" src="./images/serving-dish.png" alt="dish">
         <h5 class="card-title">Card aaaatitle3</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the 
            bulk of the card's content.
         </p>
   </div>
   <div class="cards " >
      <img class="cardimg" src="./images/serving-dish.png" alt="dish">
         <h5 class="card-title">Card aaaatitle4</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the 
            bulk of the card's content.
         </p>
   </div>
   ...
   <div style="display:none" id="mainscontent">
         <div class="cards ">
               <img class="cardimg" src="./images/menu.png" alt="menu">
               <h5 class="card-title">Card title1</h5>
               <p class="card-text">Some quick example text to build on the card title and make up the 
